...
if __name__ == '__main__':
    assert abs(fdm9h(-3.0) -  7.240015921650838E-03) < 1e-12
    assert abs(fdm9h(-1.0) - -2.442145618002432E-02) < 1e-12
    assert abs(fdm9h( 1.0) -  1.647586588274429E-02) < 1e-12
    assert abs(fdm9h( 3.5) -  1.029804636049462E-03) < 1e-12
    assert abs(fdm9h( 7.5) - -4.060975578007697E-04) < 1e-12
    assert abs(fdm9h(15.0) - -2.508232176525567E-05) < 1e-12
    assert abs(fdm9h(30.0) - -1.990373968491516E-06) < 1e-12
    assert abs(fdm9h(60.0) - -1.720097159754510E-07) < 1e-12
    assert abs(fdm7h(-3.0) - -3.545676388861523E-02) < 1e-12
    assert abs(fdm7h(-1.0) - -2.657136470551858E-02) < 1e-12
    assert abs(fdm7h( 1.0) -  9.517508954351293E-02) < 1e-12
    assert abs(fdm7h( 3.5) - -1.294450181808404E-02) < 1e-12
    assert abs(fdm7h( 7.5) - -3.613853399968076E-03) < 1e-12
    assert abs(fdm7h(15.0) - -4.935123501719669E-04) < 1e-12
    assert abs(fdm7h(30.0) - -8.248542579808003E-05) < 1e-12
    assert abs(fdm7h(60.0) - -1.440219364000877E-05) < 1e-12
    assert abs(fdm5h(-3.0) -  1.024984312340880E-01) < 1e-12
    assert abs(fdm5h(-1.0) -  3.492797177355019E-01) < 1e-12
    assert abs(fdm5h( 1.0) -  2.502420253443888E-02) < 1e-12
    assert abs(fdm5h( 3.5) - -1.233961959341110E-01) < 1e-12
    assert abs(fdm5h( 7.5) - -3.760442897358426E-02) < 1e-12
    assert abs(fdm5h(15.0) - -1.182183957963569E-02) < 1e-12
    assert abs(fdm5h(30.0) - -4.085597149537218E-03) < 1e-12
    assert abs(fdm5h(60.0) - -1.436908659724343E-03) < 1e-12
    assert abs(fdm3h(-3.0) - -1.647804107730068E-01) < 1e-12
    assert abs(fdm3h(-1.0) - -8.394844152932343E-01) < 1e-12
    assert abs(fdm3h( 1.0) - -1.580053773447138E+00) < 1e-12
    assert abs(fdm3h( 3.5) - -1.176280028545422E+00) < 1e-12
    assert abs(fdm3h( 7.5) - -7.505784586840675E-01) < 1e-12
    assert abs(fdm3h(15.0) - -5.193758746338315E-01) < 1e-12
    assert abs(fdm3h(30.0) - -3.656546825930124E-01) < 1e-12
    assert abs(fdm3h(60.0) - -2.582876225442183E-01) < 1e-12
    assert abs(fdm1h(-3.0) - 8.525970123326887E-02) < 1e-12
    assert abs(fdm1h(-1.0) - 5.211503831079912E-01) < 1e-12
    assert abs(fdm1h( 1.0) - 1.820411357146962E+00) < 1e-12
    assert abs(fdm1h( 3.5) - 3.591334824651103E+00) < 1e-12
    assert abs(fdm1h( 7.5) - 5.432873628864860E+00) < 1e-12
    assert abs(fdm1h(15.0) - 7.731513057173728E+00) < 1e-12
    assert abs(fdm1h(30.0) - 1.094942130440661E+01) < 1e-12
    assert abs(fdm1h(60.0) - 1.549016158518217E+01) < 1e-12
    assert abs( fd0h(-3.0) - 4.858735157374205E-02) < 1e-12
    assert abs( fd0h(-1.0) - 3.132616875182229E-01) < 1e-12
    assert abs( fd0h( 1.0) - 1.313261687518223E+00) < 1e-12
    assert abs( fd0h( 3.5) - 3.529750418272620E+00) < 1e-12
    assert abs( fd0h( 7.5) - 7.500552931475361E+00) < 1e-12
    assert abs( fd0h(15.0) - 1.500000030590227E+01) < 1e-12
    assert abs( fd0h(30.0) - 3.000000000000009E+01) < 1e-12
    assert abs( fd0h(60.0) - 6.000000000000000E+01) < 1e-12
    assert abs( fd1h(-3.0) - 4.336636755041557E-02) < 1e-12
    assert abs( fd1h(-1.0) - 2.905008961699176E-01) < 1e-12
    assert abs( fd1h( 1.0) - 1.396375280666564E+00) < 1e-12
    assert abs( fd1h( 3.5) - 4.837065897622567E+00) < 1e-12
    assert abs( fd1h( 7.5) - 1.399909743357599E+01) < 1e-12
    assert abs( fd1h(15.0) - 3.894304660093270E+01) < 1e-12
    assert abs( fd1h(30.0) - 1.096948183372665E+02) < 1e-12
    assert abs( fd1h(60.0) - 3.099448732700438E+02) < 1e-12
    assert abs( fd2h(-3.0) - 4.918072033882423E-02) < 1e-12
    assert abs( fd2h(-1.0) - 3.386479964034522E-01) < 1e-12
    assert abs( fd2h( 1.0) - 1.806286070444774E+00) < 1e-12
    assert abs( fd2h( 3.5) - 7.739961645298564E+00) < 1e-12
    assert abs( fd2h( 7.5) - 2.976938105893487E+01) < 1e-12
    assert abs( fd2h(15.0) - 1.141449337609459E+02) < 1e-12
    assert abs( fd2h(30.0) - 4.516449340668481E+02) < 1e-12
    assert abs( fd2h(60.0) - 1.801644934066848E+03) < 1e-12
    assert abs( fd3h(-3.0) - 6.561173880637544E-02) < 1e-12
    assert abs( fd3h(-1.0) - 4.608488062901017E-01) < 1e-12
    assert abs( fd3h( 1.0) - 2.661682624732004E+00) < 1e-12
    assert abs( fd3h( 3.5) - 1.365420168610915E+01) < 1e-12
    assert abs( fd3h( 7.5) - 6.833812856132876E+01) < 1e-12
    assert abs( fd3h(15.0) - 3.581122477085265E+02) < 1e-12
    assert abs( fd3h(30.0) - 1.985311377746038E+03) < 1e-12
#     assert abs( fd3h(60.0) - 1.117330291388515E+04) < 1e-12
    assert abs( fd3h(60.0) - 1.117330291388515E+04) < 1e-11
    assert abs( fd4h(-3.0) - 9.896340290959225E-02) < 1e-12
    assert abs( fd4h(-1.0) - 7.051297585956156E-01) < 1e-12
    assert abs( fd4h( 1.0) - 4.328331225625401E+00) < 1e-12
    assert abs( fd4h( 3.5) - 2.586637394510408E+01) < 1e-12
    assert abs( fd4h( 7.5) - 1.653001170950006E+02) < 1e-12
    assert abs( fd4h(15.0) - 1.174348022617251E+03) < 1e-12
    assert abs( fd4h(30.0) - 9.098696044010894E+03) < 1e-12
    assert abs( fd4h(60.0) - 7.219739208802179E+04) < 1e-12
    assert abs( fd5h(-3.0) - 1.647403937322051E-01) < 1e-12
    assert abs( fd5h(-1.0) - 1.185968175443467E+00) < 1e-12
    assert abs( fd5h( 1.0) - 7.626535355005596E+00) < 1e-12
    assert abs( fd5h( 3.5) - 5.186981146923186E+01) < 1e-12
    assert abs( fd5h( 7.5) - 4.158852838077063E+02) < 1e-12
    assert abs( fd5h(15.0) - 3.974487881941656E+03) < 1e-12
#     assert abs( fd5h(30.0) - 4.292925758509993E+04) < 1e-12
    assert abs( fd5h(30.0) - 4.292925758509993E+04) < 1e-11
#     assert abs( fd5h(60.0) - 4.799485008429281E+05) < 1e-12
    assert abs( fd5h(60.0) - 4.799485008429281E+05) < 1e-10
    assert abs( fd6h(-3.0) - 2.978018784709205E-01) < 1e-12
    assert abs( fd6h(-1.0) - 2.159839661017986E+00) < 1e-12
    assert abs( fd6h( 1.0) - 1.438935649349364E+01) < 1e-12
    assert abs( fd6h( 3.5) - 1.091505015453568E+02) < 1e-12
    assert abs( fd6h( 7.5) - 1.079959324343085E+03) < 1e-12
#     assert abs( fd6h(15.0) - 1.377794488724111E+04) < 1e-12
#     assert abs( fd6h(30.0) - 2.069526863744442E+05) < 1e-12
    assert abs( fd6h(60.0) - 3.257776652315915E+06) < 1e-12
    assert abs( fd7h(-3.0) - 5.778455375087482E-01) < 1e-12
    assert abs( fd7h(-1.0) - 4.213264071926359E+00) < 1e-12
    assert abs( fd7h( 1.0) - 2.883131841599375E+01) < 1e-12
    assert abs( fd7h( 3.5) - 2.396666058159899E+02) < 1e-12
    assert abs( fd7h( 7.5) - 2.880213529254126E+03) < 1e-12
    assert abs( fd7h(15.0) - 4.868423690758540E+04) < 1e-12
#     assert abs( fd7h(30.0) - 1.014417201742514E+06) < 1e-12
    assert abs( fd7h(30.0) - 1.014417201742514E+06) < 1e-9
#     assert abs( fd7h(60.0) - 2.246912083856067E+07) < 1e-12
    assert abs( fd7h(60.0) - 2.246912083856067E+07) < 1e-8
    assert abs( fd8h(-3.0) - 1.193042623617263E+00) < 1e-12
    assert abs( fd8h(-1.0) - 8.732138288905944E+00) < 1e-12
    assert abs( fd8h( 1.0) - 6.096945037216665E+01) < 1e-12
    assert abs( fd8h( 3.5) - 5.469755138110205E+02) < 1e-12
    assert abs( fd8h( 7.5) - 7.862865080220864E+03) < 1e-12
#     assert abs( fd8h(15.0) - 1.747634735470307E+05) < 1e-12
    assert abs( fd8h(30.0) - 5.039016606494085E+06) < 1e-12
    assert abs( fd8h(60.0) - 1.569439504883058E+08) < 1e-12
    assert abs( fd9h(-3.0) - 2.603141667351258E+00) < 1e-12
    assert abs( fd9h(-1.0) - 1.910506806522883E+01) < 1e-12
    assert abs( fd9h( 1.0) - 1.354192084601931E+02) < 1e-12
    assert abs( fd9h( 3.5) - 1.293868145709697E+03) < 1e-12
#     assert abs( fd9h( 7.5) - 2.192168139830375E+04) < 1e-12
    assert abs( fd9h(15.0) - 6.358400491901155E+05) < 1e-12
#     assert abs( fd9h(30.0) - 2.530631914465860E+07) < 1e-12
#     assert abs( fd9h(60.0) - 1.107558362743446E+09) < 1e-12
    assert abs( fd10h(-3.0) - 5.969820680488160E+00) < 1e-12
    assert abs( fd10h(-1.0) - 4.389948426765305E+01) < 1e-12
    assert abs( fd10h( 1.0) - 3.146680541843087E+02) < 1e-12
    assert abs( fd10h( 3.5) - 3.165640736730491E+03) < 1e-12
    assert abs( fd10h( 7.5) - 6.231539440840174E+04) < 1e-12
#     assert abs( fd10h(15.0) - 2.340617854292586E+06) < 1e-12
#     assert abs( fd10h(30.0) - 1.282644990485829E+08) < 1e-12
    assert abs( fd10h(60.0) - 7.883001082246370E+09) < 1e-12
    assert abs( fd11h(-3.0) - 1.432510773316834E+01) < 1e-12
    assert abs( fd11h(-1.0) - 1.054873701421355E+02) < 1e-12
    assert abs( fd11h( 1.0) - 7.624071301487685E+02) < 1e-12
    assert abs( fd11h( 3.5) - 7.997774066508814E+03) < 1e-12
#     assert abs( fd11h( 7.5) - 1.804014784983563E+05) < 1e-12
    assert abs( fd11h(15.0) - 8.706355279385276E+06) < 1e-12
    assert abs( fd11h(30.0) - 6.552423229390368E+08) < 1e-12
#     assert abs( fd11h(60.0) - 5.651215902520975E+10) < 1e-12
    assert abs( fd12h(-3.0) - 3.583278660538172E+01) < 1e-12
    assert abs( fd12h(-1.0) - 2.641275790125708E+02) < 1e-12
    assert abs( fd12h( 1.0) - 1.920621491104163E+03) < 1e-12
#     assert abs( fd12h( 3.5) - 2.083671641045758E+04) < 1e-12
    assert abs( fd12h( 7.5) - 5.314330295476191E+05) < 1e-12
#     assert abs( fd12h(15.0) - 3.269159748061942E+07) < 1e-12
#     assert abs( fd12h(30.0) - 3.370296449774471E+09) < 1e-12
    assert abs( fd12h(60.0) - 4.076323551443539E+11) < 1e-12
    assert abs( fd13h(-3.0) - 9.313870302507033E+01) < 1e-12
    assert abs( fd13h(-1.0) - 6.870205993243595E+02) < 1e-12
    assert abs( fd13h( 1.0) - 5.017993045210247E+03) < 1e-12
    assert abs( fd13h( 3.5) - 5.591696834104130E+04) < 1e-12
#     assert abs( fd13h( 7.5) - 1.592092071043047E+06) < 1e-12
#     assert abs( fd13h(15.0) - 1.238219532435030E+08) < 1e-12
#     assert abs( fd13h(30.0) - 1.744018597946511E+10) < 1e-12
#     assert abs( fd13h(60.0) - 2.956078846984141E+12) < 1e-12
    assert abs( fd14h(-3.0) - 2.508781184723398E+02) < 1e-12
    assert abs( fd14h(-1.0) - 1.851484886980967E+03) < 1e-12
#     assert abs( fd14h( 1.0) - 1.356711459868958E+04) < 1e-12
#     assert abs( fd14h( 3.5) - 1.544073285162487E+05) < 1e-12
    assert abs( fd14h( 7.5) - 4.848712724195143E+06) < 1e-12
    assert abs( fd14h(15.0) - 4.727830603631850E+08) < 1e-12
    assert abs( fd14h(30.0) - 9.073325961350024E+10) < 1e-12
    assert abs( fd14h(60.0) - 2.153759508773864E+13) < 1e-12
    assert abs( fd15h(-3.0) - 6.986360585012507E+02) < 1e-12
    assert abs( fd15h(-1.0) - 5.157783274159222E+03) < 1e-12
    assert abs( fd15h( 1.0) - 3.788356128997377E+04) < 1e-12
#     assert abs( fd15h( 3.5) - 4.383205315095304E+05) < 1e-12
#     assert abs( fd15h( 7.5) - 1.500759095117367E+07) < 1e-12
    assert abs( fd15h(15.0) - 1.818973214398967E+09) < 1e-12
#     assert abs( fd15h(30.0) - 4.743320667852189E+11) < 1e-12
#     assert abs( fd15h(60.0) - 1.575715160529580E+14) < 1e-12
    assert abs( fd16h(-3.0) - 2.007219646720646E+03) < 1e-12
#     assert abs( fd16h(-1.0) - 1.482234071460382E+04) < 1e-12
#     assert abs( fd16h( 1.0) - 1.090540532961069E+05) < 1e-12
#     assert abs( fd16h( 3.5) - 1.277985060309017E+06) < 1e-12
#     assert abs( fd16h( 7.5) - 4.720135119144394E+07) < 1e-12
    assert abs( fd16h(15.0) - 7.049084121468240E+09) < 1e-12
#     assert abs( fd16h(30.0) - 2.490622378495212E+12) < 1e-12
#     assert abs( fd16h(60.0) - 1.157079836302754E+15) < 1e-12
    assert abs( fd17h(-3.0) - 5.938814014650166E+03) < 1e-12
    assert abs( fd17h(-1.0) - 4.386311784955336E+04) < 1e-12
#     assert abs( fd17h( 1.0) - 3.231138561347001E+05) < 1e-12
#     assert abs( fd17h( 3.5) - 3.823781896168859E+06) < 1e-12
#     assert abs( fd17h( 7.5) - 1.508420732678749E+08) < 1e-12
#     assert abs( fd17h(15.0) - 2.750798130249417E+10) < 1e-12
#     assert abs( fd17h(30.0) - 1.313056860664467E+13) < 1e-12
    assert abs( fd17h(60.0) - 8.524941900028644E+15) < 1e-12
    assert abs( fd18h(-3.0) - 1.806585371781600E+04) < 1e-12
#     assert abs( fd18h(-1.0) - 1.334484320310655E+05) < 1e-12
    assert abs( fd18h( 1.0) - 9.839000912153142E+05) < 1e-12
#     assert abs( fd18h( 3.5) - 1.173074963158710E+07) < 1e-12
    assert abs( fd18h( 7.5) - 4.897833845586907E+08) < 1e-12
#     assert abs( fd18h(15.0) - 1.080715538012005E+11) < 1e-12
    assert abs( fd18h(30.0) - 6.948254776893934E+13) < 1e-12
    assert abs( fd18h(60.0) - 6.299767361155796E+16) < 1e-12
#     assert abs( fd19h(-3.0) - 5.642067020436533E+04) < 1e-12
#     assert abs( fd19h(-1.0) - 4.168044535669152E+05) < 1e-12
    assert abs( fd19h( 1.0) - 3.074986313749142E+06) < 1e-12
    assert abs( fd19h( 3.5) - 3.686910477586340E+07) < 1e-12
#     assert abs( fd19h( 7.5) - 1.615856749616024E+09) < 1e-12
    assert abs( fd19h(15.0) - 4.273879330919564E+11) < 1e-12
#     assert abs( fd19h(30.0) - 3.689532972232714E+14) < 1e-12
    assert abs( fd19h(60.0) - 4.668155109009914E+17) < 1e-12
#     assert abs(fd20h(-3.0) - 1.806629241770091E+05) < 1e-12
#     assert abs(fd20h(-1.0) - 1.334722123421517E+06) < 1e-12
    assert abs(fd20h( 1.0) - 9.851381090333600E+06) < 1e-12
#     assert abs(fd20h( 3.5) - 1.186176377953597E+08) < 1e-12
    assert abs(fd20h( 7.5) - 5.416646367586654E+09) < 1e-12
#     assert abs(fd20h(15.0) - 1.701154132363905E+12) < 1e-12
    assert abs(fd20h(30.0) - 1.965505543248569E+15) < 1e-12
    assert abs(fd20h(60.0) - 3.467790683237043E+18) < 1e-12
    assert abs(fd21h(-3.0) - 5.924272114982210E+05) < 1e-12
    assert abs(fd21h(-1.0) - 4.376998997938984E+06) < 1e-12
    assert abs(fd21h( 1.0) - 3.231634166275790E+07) < 1e-12
    assert abs(fd21h( 3.5) - 3.903364896044762E+08) < 1e-12
    assert abs(fd21h( 7.5) - 1.845016484905844E+10) < 1e-12
    assert abs(fd21h(15.0) - 6.814687278457835E+12) < 1e-12
#     assert abs(fd21h(30.0) - 1.050272666569349E+16) < 1e-12
#     assert abs(fd21h(60.0) - 2.582022264434903E+19) < 1e-12

# create derivative functions
def create_df(k, f):
    return lambda x: k*f(x)
for num in range(-7, 0, 2)+range(1, 24):
    k = num/2.
    dname = ('dfd{:g}h'.format(num)).replace('-', 'm')
    assert dname not in globals()
    fname = ('fd{:g}h'.format((k-1)*2)).replace('-', 'm')
#     print 'k > 0: {} = {:g}*{}'.format(dname, k, fname)
    f = globals()[fname]
    df = create_df(k, f)
    globals()[dname] = df

# dfd1h = lambda x: 0.5*fdm1h(x)

# vectorize all of the functions and add them to __all__
__all__ = []
for name, func in sorted(globals().items()):
    if name.startswith('fd') or name.startswith('dfd'):
#         print name, func
        __all__.append(name)
        globals()['_'+name] = func
        globals()[name] = numpy.vectorize(func)

if __name__ == "__main__":
    import matplotlib.pyplot as plt
    _, ax = plt.subplots()
    phi = numpy.linspace(-30, 50, 10000)
    for num in range(-7, 0, 2)+range(1, 22):
        k = num/2.
        dname = ('dfd{:g}h'.format(num)).replace('-', 'm')
        fname = ('fd{:g}h'.format(num)).replace('-', 'm')
        ax.semilogy(phi, globals()[fname](phi), 'r')
        ax.semilogy(phi, globals()[dname](phi), 'b')
    plt.show()